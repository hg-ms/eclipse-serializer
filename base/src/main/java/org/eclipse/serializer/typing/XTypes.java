...
public final class XTypes
{
	...
	public static boolean isDirectByteBuffer(final ByteBuffer byteBuffer)
	{
		notNull(byteBuffer);
	...
	public static ByteBuffer guaranteeDirectByteBuffer(final ByteBuffer directBuffer)
	{
		// null-check inside
	...
	public static byte to_byte(final boolean value)
	{
		return value
			? (byte)1
			: (byte)0
	...
	public static boolean to_boolean(final byte value)
	{
		return value != 0;
	}
	...
	public static int to_int(final long value) throws NumberRangeException
	{
	...
	public static int to_int(final float value) throws NumberRangeException
	{
		if(value > Integer.MAX_VALUE)
		{
			throw new IllegalArgumentException(value + " > " + Integer.MAX_VALUE);
	...
	public static int to_int(final double value) throws NumberRangeException
	{
		if(value > Integer.MAX_VALUE)
		{
			throw new IllegalArgumentException(value + " > " + Integer.MAX_VALUE);
	...
	public static int to_int(final Number value) throws NumberRangeException, NullPointerException
	{
	...
	public static Byte asByte(final Number value)
	{
		return value == null
			? null
	...
	public static Short asShort(final Number value)
	{
		return value == null
			? null
	...
	public static Integer asInteger(final Number value)
	{
		return value == null
			? null
	...
	public static Float asFloat(final Number value)
	{
		return value == null
			? null
	...
	public static Long asLong(final Number value)
	{
		return value == null
			? null
	...
	public static Double asDouble(final Number value)
	{
		return value == null
			? null
